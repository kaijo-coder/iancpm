...
from iancpm import CarParkTool
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @IAN ')) 
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '========[ ACCESS KEYDETAILS ]========'))
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.rainbow, '=============[ ADDRESS ]============='))
    ...
    print(Colorate.Horizontal(Colors.rainbow, '===============[ SERVICES ]==============='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ ☆SELECT SERVICE☆ ]==============='))
